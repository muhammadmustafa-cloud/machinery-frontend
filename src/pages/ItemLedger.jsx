...
export default function ItemLedger() {
  ...
  const exportPDF = () => {
    ...
    const tableColumn = ['Date', 'Type', 'Quantity', 'Balance', 'Machine / Supplier', 'Remarks'];
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 dark:bg-zinc-900/50 border-b border-gray-200 dark:border-zinc-800">
                ...
                <th className="px-6 py-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Running Balance</th>
